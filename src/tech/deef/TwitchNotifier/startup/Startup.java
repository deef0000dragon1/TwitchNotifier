...
import tech.deef.TwitchNotifier.testing.JsonReaderTest;

/**
 * main class to test and deploy. Curently set up using hard coded names.
 */
public class Startup extends JFrame {
	...
	private void createGui() {
		...
		// use name from list of names to create a channel and add to list of
		// channels
		...
		for (ChannelStatus channel : channelInfo) {
			// create the gui layout for the panel. Not effective to what I
			// need.
